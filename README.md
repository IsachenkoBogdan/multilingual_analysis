...
Мы используем стандартный `pip` и Python 3.10 — никаких дополнительных менеджеров не требуется.
...
- Добавлены указания по созданию окружения через стандартный `pip` и использованию Python 3.10.
